const { createVendor, updateVendor, verifyVendorEmail, vendorLogin, vendorLogout, forgotPassword, resetPassword, getAllVendors, getOneVendor, resendOtp } = require('../controller/vendorController');
