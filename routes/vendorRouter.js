const { createVendor, updateVendor, verifyVendorEmail, vendorLogin, vendorLogout, forgotPassword, resetPassword, changePassword, getOneVendor, resendOtp } = require('../controller/vendorController');
