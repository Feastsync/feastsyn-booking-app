...
const { createBooking, getVendorBookings, acceptBooking, rejectBooking, getBookingDetails, getClientBookings, getSingleBooking, markServiceDelivered} = require('../controller/bookingController');
...
router.put('/service-delivered/:bookingId', authentication, markServiceDelivered);
